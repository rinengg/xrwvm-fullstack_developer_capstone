...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://*.proxy.cognitiveclass.ai', 'http://localhost:8000']
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'frontend/static'), os.path.join(BASE_DIR, 'frontend/build/static')]
